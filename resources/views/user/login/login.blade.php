                    ...
                    <div class="container">
                        <div class="text-center">
                            <div class="col-lg-12">
                                <div class="login-txt">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group login-dvh-rua">
                                            ...
                                            <input name="email" id="txt" type="email" placeholder="Email" required="">
                                            @error('email')
                                ...
                                <p class="account">Chưa có tài khoản
                                    <a href="{{route('user.register')}}" class="d-inline-block">Tạo tài khoản</a>
                                </p>
